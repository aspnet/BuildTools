...
namespace Scenarios
{
    ...
    public class AuthorizeFilter : IFilterFactory
    {
    }
    ...
    public class ClassOverridingVirtualMethodFromBaseClass : IntermediateSubclassNotPartiallyOverridingImplementation
    {
        public override bool CanWrite(object value) => false;
    }

    public class IntermediateSubclassNotPartiallyOverridingImplementation : BaseClassImplementingInterface
    {
    ...
    public class BaseClassImplementingInterface : IBaseInterface
    {
        public virtual bool CanWrite(object value) => false;
    ...
    public class ConsumesAttribute : Attribute, IConsumesActionConstraint
    {
    ...
    public interface IActionConstraint : IFilterMetadata
    {
        bool Accept();
    }
