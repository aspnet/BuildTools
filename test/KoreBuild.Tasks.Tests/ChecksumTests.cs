...
namespace KoreBuild.Tasks.Tests
{
    public class ChecksumTests
    {
        ...
        {
            var task = new ComputeManyChecksum
            {
                Items = new[] { new TaskItem(Path.Combine(AppContext.BaseDirectory, "TestResources", "lorem.bin")) },
                BuildEngine = new MockEngine(),
                Algorithm = algoritm,
            };
            ...
            Assert.Equal(hash, item.GetMetadata("FileHash"));
        }
